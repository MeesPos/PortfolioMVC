        ...
        <section id="addSkill">
            ...
            <form action="<?php echo url('insertSkill') ?>" method="POST">
                <div class="nameAndIcon">
                    ...
                    <input type="text" placeholder="Skillnaam Nederlands..." name="skill" id="skill">
                </div>
                ...
                <div class="titleSection">
                    <input placeholder="Skillnaam Engels..." type="text" name="skillen" id="skillen" style="width: 83%;">
                </div>

                <div class="skillNiveau">
                    <select name="skillNiveauEn" id="skillNiveau" style="margin-top: 1vh;">
        ...
        <section id="allPosts">
            ...
            <?php foreach ($skills as $row) : ?>
                <div class="posts skill-<?php echo $row['id'] ?>">
                    <h4><?php echo $row['id'] ?>. <i class="<?php echo $row['fa-class'] ?>"></i> <?php echo $row['skillnaam_nl'] ?></h4>
